...
class BrowserCrew:
    ...
    # ... остальной код почти без изменений, но инициализация агентов обновлена ...
    def _log(self, message): self.log_callback(message)
    ...
    def run(self, topic: str, log_callback_from_engine, update_callback_from_engine):
        ...
        # ИЗМЕНЕНО: Передаем internal_router в агенты
