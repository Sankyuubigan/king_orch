...
- **browser** — инструменты: `BrowserDownload`, `BrowserFetch`, `BrowserSearch`, `BrowserSession`, `browser`
...
- **downloader** — инструменты: `download_file`, `downloader`
