...
2. давай определим ядро программы (минимальный функционал) и сделаем связь между модульными плагинами - асинхронные очереди.  это позволит реализовать расширяемость в будущем и легкую разработку новых фич.
...
9. надо лайфхаки для кода. https://github.com/coleam00/context-engineering-intro
https://github.com/Wirasm/PRPs-agentic-eng . https://github.com/bmadcode/BMAD-METHOD
10. кодер - архитектура, а потом фикс багов. норм ли архитектура для фикса бага?
11. битбакет мцп
12. таролог. инструкция для юзера - фокус на истине, качественный Сфокусированный Конкретные, серьезные честные вопросы. Эмоциональная вовлеченность . Синхронистичность - значимое совпадение. генератор номера карт колоды. компьютерное зрение + Символическая интерпретация всех карт синтез.
